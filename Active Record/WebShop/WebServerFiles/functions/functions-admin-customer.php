...
?>
    <div class="container">
        <div style="text-align: right; padding: 15px;">
            <a href="?cat=customer&action=add" class="btn btn-primary rounded">
                <i class="bi bi-file-plus"></i> Add Customer
            </a>
        </div>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    foreach ($customers as $customer) {
                        ...
                        echo "<a href='?cat=customer&action=edit&customerId=" . $customer['CustomerID'] . "' class='btn btn-primary rounded'><i class='bi bi-pencil-square'></i> Edit</a>";
                        echo "</td>";
                        echo "<td class='align-middle' style='width: 10%'>";
                        echo "<a href='?cat=customer&action=delete&customerId=" . $customer['CustomerID'] . "' class='btn btn-danger rounded'><i class='bi bi-trash'></i> Delete</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
...
?>
    <div class="container mt-4">
        ...
        <form method="post" action="">
            ...
            <button type="submit" class="btn btn-primary rounded">Add Customer</button>
        </form>
    </div>
    <?php
...
function renderEditCustomerForm($host, $dbname, $user, $password, $customerId = null)
{
    ...
    <div class="container mt-4">
        ...
        <form method="post" action="">
            ...
            <button type="submit" class="btn btn-primary rounded">Update Customer</button>
        </form>
    ...
    <div class="container mt-4">
        ...
        <form method="post" action="">
            <div class="mb-3">
                ...
                <input type="number" id="customerId" name="customerId" class="form-control"
                    value="<?php echo htmlspecialchars($customerId); ?>" required readonly>
            </div>
            <button type="submit" class="btn btn-danger rounded">Delete Customer</button>
        </form>
