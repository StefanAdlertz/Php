...
<body>
    <div class="container mt-4">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark container-fluid w-100">
            <a class="navbar-brand" href="https://adlertz.se/shop/admin.php">&nbsp;&nbsp;Web Shop Admin</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://adlertz.se/shop/admin.php?cat=product&action=list">Product</a>
                    </li>
                </ul>
            </div>
        </nav>
